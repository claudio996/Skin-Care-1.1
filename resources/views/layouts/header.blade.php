...
<head>
    ...
    <!-- site icons -->
    <link rel="icon" href="aasets/images/fevicon/fevicon.png" type="image/gif" />
    <!-- bootstrap css -->
...
<body id="default_theme" class="it_service">
    <!-- loader -->
    <div class="bg_load"> <img class="loader_animation" src="assets/images/loaders/loader_1.png" alt="#" />
    </div>
    <!-- end loader -->
    <!-- header -->
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-3 col-md-12 col-sm-12 col-xs-12">
                        <!-- logo start -->
                        <div class="logo"> <a href="it_home.html"><img src="assets/images/logos/it_logo.png"
                                    alt="logo" /></a> </div>
                        <!-- logo end -->
                    </div>
